...
public class PropiedadAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(context).load("https://api.ofcorp.com.ec/img/"+listPropiedades.get(position).getImagen()).centerCrop().into(imageView);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("idPropiedad", listPropiedades.get(position).getId_finca());
                intent.putExtra("urlImagen", listPropiedades.get(position).getImagen());
